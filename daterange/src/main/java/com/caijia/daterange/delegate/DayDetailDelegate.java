...
public class DayDetailDelegate extends ItemViewDelegate<DayBean, DayDetailDelegate.DayVH> {
    ...
    public DayDetailDelegate(Context context, OnDateClickListener onDateClickListener) {
    ...
    public DayVH onCreateViewHolder(LayoutInflater inflater, ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_day_detail_delegate, parent, false);
    ...
    static class DayVH extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public DayVH(View itemView, OnDateClickListener onDateClickListener) {
            ...
            itemView.getLayoutParams().height = (int) (height * 0.9f);
        }
